...
После этого дополнительно выполняется `pg_switch_wal()`, чтобы WAL с последними изменениями гарантированно был отправлен в архив и стал доступен для PITR на резервном узле.
